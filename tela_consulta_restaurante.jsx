...
// como Card, Button, Input, etc., precisam que o 'shadcn/ui' esteja configurado
// em seu projeto.
...
// Dados de exemplo para os restaurantes
    ...
    <div className={`min-h-screen w-full ${bgGradient} relative overflow-x-hidden`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="relative">
            <Input
              ...
              className="pl-10 h-12 text-base bg-white shadow-md"
              value={searchTerm}
        ...
        {filteredRestaurants.length === 0 && (
          ...
          >
            <p className="text-white text-lg font-semibold">Nenhum restaurante encontrado.</p>
