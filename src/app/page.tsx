...
"use client"; // Necessário para usar o componente <Link> para navegação

import Link from 'next/link'; // Componente do Next.js para navegação rápida
...
export default function HomePage() {
  return (
    ...
    <main className="flex flex-col items-center justify-center min-h-screen p-8"
      ...
      <div className="bg-white rounded-lg shadow-2xl p-8 md:p-12 max-w-xl w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          {/* Botão Secundário (ou de cadastro) */}
